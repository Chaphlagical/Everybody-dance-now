...
source_dir = Path('./data/source/'+source_name+'/test_img')
target_dir = Path('./results/target/test_latest/images')
label_dir = Path('./data/source/'+source_name+'/test_label_ori')
...
anim.save("output/"+source_name+"-"+target_name+".gif", writer="imagemagick")
plt.close()